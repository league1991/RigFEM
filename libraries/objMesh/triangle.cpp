...
double TriangleBasic::distanceToPoint( Vec3d point )
{
	return sqrt(distanceToPoint2(point));
}

double TriangleBasic::distanceToPoint2( Vec3d point )
{
	std::cout << "Unimplemented..." << std::endl; return 1;
}
